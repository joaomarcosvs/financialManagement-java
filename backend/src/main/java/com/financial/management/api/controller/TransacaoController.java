...
public class TransacaoController {
    ...
    public ResponseEntity<TransacaoResponseDTO> atualizar(
        ...
        Transacao transacaoAtualizada = toEntity(request);
        Transacao transacaoSalva = transacaoService.atualizarTransacao(id, transacaoAtualizada);
        return ResponseEntity.ok(toResponseDTO(transacaoSalva));
    }
    ...
    private Transacao toEntity(TransacaoRequestDTO request) {
